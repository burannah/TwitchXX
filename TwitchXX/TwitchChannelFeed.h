...
namespace TwitchXX
{
	...
	public:
		...
		TwitchPost GetPost(const std::wstring& channel_name, unsigned long long id) const; //TODO: size_t is not quite right. May be will had to change to string type
		TwitchPost Post(const std::wstring& channel_name, const std::wstring& body, bool share = false) const;
		bool DeletePost(const std::wstring& channel_name, unsigned long long id) const; //TODO: size_t -> string?
